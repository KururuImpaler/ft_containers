...
void	const_reverse_iterator() {
	mkdir("./test/vector/const_reverse_iterator", 0777);
	...
	/*  OPERATOR*  */
	{
		...
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 1, "./test/vector/const_reverse_iterator/operator*");

		/*Test2*/
		bool	two = (*ft_it == *std_it);
		list_push(std_lst, ft_lst, *std_it, *ft_it);
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 2, "./test/vector/const_reverse_iterator/operator*");


		bool	three = test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec, mode, 3, "./test/vector/const_reverse_iterator/operator*");
	...
	/*  OPERATOR++  */
	{
		...
		list_push(std_lst, ft_lst, *(std_it), *(ft_it));
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 3, "./test/vector/const_reverse_iterator/operator++");


		bool	four = test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec, mode, 4, "./test/vector/const_reverse_iterator/operator++");
	...
	/*  OPERATOR==  */
	{
		...
		print_test_iterator<bool, std::list<bool>::const_iterator>(std_lst, ft_lst, mode, 1, "./test/vector/const_reverse_iterator/operator==");
		...
		list_push<bool>(std_lst, ft_lst, std_bool, ft_bool);
		print_test_iterator<bool, std::list<bool>::const_iterator>(std_lst, ft_lst, mode, 2, "./test/vector/const_reverse_iterator/operator==");
	...
	/*  OPERATOR<=  */
	{
		...
		list_push<bool>(std_lst, ft_lst, std_bool, ft_bool);
		print_test_iterator<bool, std::list<bool>::const_iterator>(std_lst, ft_lst, mode, 3, "./test/vector/const_reverse_iterator/operator<=");
	...
	/*  OPERATOR+  */
	{
		...
		print_test_iterator<int, std::list<int>::const_iterator>(std_lst, ft_lst, mode, 4, "./test/vector/const_reverse_iterator/operator+");

		bool	five = test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::const_iterator, ft::vector<int>::const_iterator>(std_vec, ft_vec, mode, 5, "./test/vector/const_reverse_iterator/operator+");
