...
void	reverse_iterator() {
	mkdir("./test/vector/reverse_iterator", 0777);
	std::cout << "Reverse:\t|";
	std::list<int>	lst;
	lst.push_back(10);
	lst.push_back(99);
	...
	/*  OPERATOR*  */
	{
		...
		print_test_iterator<int, std::list<int>::iterator>(std_lst, ft_lst, mode, 1, "./test/vector/reverse_iterator/operator*");
		*ft_it = 11;
		*std_it = 11;
		...
		print_test_iterator<int, std::list<int>::iterator>(std_lst, ft_lst, mode, 2, "./test/vector/reverse_iterator/operator*");


		bool	three = test_vector<int, std::vector<int>::iterator, ft::vector<int>::iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::iterator, ft::vector<int>::iterator>(std_vec, ft_vec, mode, 3, "./test/vector/reverse_iterator/operator*");
	...
	/*  OPERATOR++  */
	{
		...
		*std_it = 11;
		...
		list_push(std_lst, ft_lst, *(std_it), *(ft_it));
		print_test_iterator<int, std::list<int>::iterator>(std_lst, ft_lst, mode, 3, "./test/vector/reverse_iterator/operator++");


		bool	four = test_vector<int, std::vector<int>::iterator, ft::vector<int>::iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::iterator, ft::vector<int>::iterator>(std_vec, ft_vec, mode, 4, "./test/vector/reverse_iterator/operator++");
	...
	/*  OPERATOR==  */
	{
		...
		print_test_iterator<bool, std::list<bool>::iterator>(std_lst, ft_lst, mode, 1, "./test/vector/reverse_iterator/operator==");
		ft_it[6] = 11;
		std_it[6] = 11;
		...
		list_push<bool>(std_lst, ft_lst, std_bool, ft_bool);
		print_test_iterator<bool, std::list<bool>::iterator>(std_lst, ft_lst, mode, 2, "./test/vector/reverse_iterator/operator==");
		ft_it[6] = 11;
		std_it[6] = 11;
	...
	/*  OPERATOR<=  */
	{
		...
		list_push<bool>(std_lst, ft_lst, std_bool, ft_bool);
		print_test_iterator<bool, std::list<bool>::iterator>(std_lst, ft_lst, mode, 3, "./test/vector/reverse_iterator/operator<=");
		ft_it[6] = 11;
		std_it[6] = 11;
	...
	/*  OPERATOR+  */
	{
		...
		*(std_it + 18) = 11;
		...
		print_test_iterator<int, std::list<int>::iterator>(std_lst, ft_lst, mode, 4, "./test/vector/reverse_iterator/operator+");

		bool	five = test_vector<int, std::vector<int>::iterator, ft::vector<int>::iterator>(std_vec, ft_vec);
		print_test_vector<int, std::vector<int>::iterator, ft::vector<int>::iterator>(std_vec, ft_vec, mode, 5, "./test/vector/reverse_iterator/operator+");
